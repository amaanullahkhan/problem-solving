...
func countInversions( arr: inout [Int]) -> Int {
    ...
    func mergeSort(array: inout [Int], temp: inout [Int], start: Int, end: Int) {
        ...
        let mid = (start + end) / 2
        mergeSort(array: &array, temp: &temp, start: start, end: mid)
        mergeSort(array: &array, temp: &temp, start: mid+1, end: end)
        merge(array: &array, temp: &temp, start: start, mid: mid, end: end)
    }

    func merge(array: inout [Int], temp: inout [Int], start: Int, mid: Int, end: Int) {
    ...
    mergeSort(array: &arr, temp: &temp, start: 0, end: arr.count-1)
